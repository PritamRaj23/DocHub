                    ...
                    <div className="profile-body">
                        <form>
                            <div className="form-group">
                                ...
                                <p className="profile-text">{profileData.name || "N/A"}</p>
                            </div>
                            <div className="form-group">
                                <label htmlFor="email">Email</label>
                                <p className="profile-text">{profileData.email || "N/A"}</p>
                            </div>
                            <div className="form-group">
                            ...
                            <div className="form-group">
                                ...
                                <p className="profile-text">{profileData.gender || "N/A"}</p>
                            </div>
                            <div className="form-group">
                            ...
                            <div className="form-group">
                                ...
                                <p className="profile-text">{profileData.department || "N/A"}</p>
                            </div>
                        </form>
                    </div>
                    <div className="profile-footer">
                        <button className="btn btn-save" onClick={handleSave}>Save Profile</button>
